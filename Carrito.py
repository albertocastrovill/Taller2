...
def Grabar():
    ...
    out=cv2.VideoWriter('Prueba2.mp4',fourcc,20.0,(640,480))
...
def Autonomo():
    ...
    path_to_images = "/home/albertocastro/Escritorio/Taller/image-dataset"
    img_name = "G0073482.JPG"
