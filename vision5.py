...
def pipeline(path_to_images, img_name):
        ...
        img_colour_with_lines= cv2.cvtColor(img_colour_with_lines, cv2.COLOR_RGB2BGR)
        ...
        left_slope_mean, left_slope_std = -14.65, 3
        right_slope_mean, right_slope_std = 18.45, 3
        ...
        for line in hough_lines:
            for x1, y1, x2, y2 in line:
                ...
                print(slope)
                print(slope_deg)
                cv2.line(img_colour_with_lines, (x1, y1), (x2, y2), (0,0,255), 2)
        ...
        cv2.line(img_colour_with_lines, (x_minl, int(y_bottoml[0])), (x_maxl, int(y_topl[0])), (0,255,0), 3)
        ...
        cv2.line(img_colour_with_lines, (x_minr, int(y_bottomr[0])), (x_maxr, int(y_topr[0])), (0,255,0), 3)
