...
cap = cv2.imread('/home/albertocastro/Escritorio/Taller/dataset2/opencv_frame_1.png')
scap=100
...
while cap.isOpened():
    ...
    if (ret is True):   
        ...
        left_slope_mean, left_slope_std = -11.43594, 1.5
        #right_slope_mean, right_slope_std = 21.713840954352456, 1.7311898404656396
        right_slope_mean, right_slope_std= 30, 20
