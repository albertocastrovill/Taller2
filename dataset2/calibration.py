...
images=glob.glob('/home/albertocastro/Escritorio/Taller/calib/*.jpg') #DIRECCION DE TUS IMAGENES
print(images)
for fname in images:
    img = cv.imread(fname)
...
img = cv.imread('/home/albertocastro/Escritorio/Taller/calib/chess1.jpg')
""" METODO 1
h,  w = img.shape[:2]
